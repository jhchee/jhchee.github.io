...
const Project: React.FC<BlogProps> = ({ allPostsData }) => {
  ...
  return (
    <LayoutWrapper home>
      ...
      <section className="divide-y">
        <div>
          <h2 className="text-3xl sm:text-5xl font-bold mt-7 sm:mt-5">
            Projects
          </h2>
...
export async function getStaticProps() {
  const allPostsData = getSortedPostsBySection("project");
  return {
    props: {
      allPostsData,
    },
